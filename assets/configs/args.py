...
class args_parse():
    ...
    def init_args(self):
        ...
        self.parser.add_argument('--host', type=str, default='localhost')
        self.parser.add_argument('--port', type=int, default=12121)
        self.parser.add_argument('--model_path', type=str, default='assets/checkpoint/epoch_3.pth')
